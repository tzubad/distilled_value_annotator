...
class PipelineOrchestrator:
    ...
    def __init__(self, config: PipelineConfig):
        ...
        # Initialize processors with shared pipeline logger
        ...
        logging.info("PipelineOrchestrator initialized successfully")
        self.pipeline_logger.log_info("PipelineOrchestrator initialized successfully")
    ...
    def run(self) -> Dict[str, Any]:
        """
        Execute the pipeline based on the configured stage setting.
        Routes to the appropriate stage method based on config.stage_to_run.
